...
public:
    ...
    // static TerrainConfig loadFromFile(const std::string fullFilePath = "/home/rpradeep/Desktop/kft/config/terrain.ini")
    static TerrainConfig loadFromFile(const std::string fullFilePath = "/home/pradeepr/Desktop/kft/config/terrain.ini")
    {
